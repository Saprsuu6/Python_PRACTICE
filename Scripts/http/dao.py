...
class UserDAO:
    ...
    def get_users(self, ignore_deleted=True) -> tuple or None:
    ...
    def get_user(self, id=None, login=None, ignore_deleted=True) -> User or None:
    ...
    def auth_user(self, login: str, password: str) -> User or None:
        '''User authentication'''
...
class AccessTokenDAO:
    ...
    def create(self, user: str or User) -> AccessToken or None:
    ...
    def get(self, access_token: str) -> AccessToken or None:
    ...
    def get_by_user(self, user: User) -> AccessToken or None:
